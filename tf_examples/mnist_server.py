...
from tf_models.model import load_graph
...
if __name__ == "__main__":
    ...
    graph = load_graph(args.frozen_model_filename, (1, 28, 28, 1), old_input="MnistNetwork_1/input:0")
    x = graph.get_tensor_by_name('input_tensor:0')
    y = graph.get_tensor_by_name('MnistNetwork_1/probs:0')
